        ...
        <div class="card-body">
            <form action="" method="post">
                ...
                <div class="text-center">
                    <input type="submit" class="btn btn-outline-primary my-3" name="add" value="Add Product">
                </div>
            </form>
        </div>
    </div>
        ...
        <div class="card-body">
            <table class="table table-secondary">
                ...
                <tr>
                    ...
                    <td><a href="index.php?update=<?=$item['id']?>"><i class="fa-solid fa-pen text-dark"></i></a></td>
